...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>
      EasyUI | Free React & Tailwind Components
    </title>
    <link
      rel="shortcut icon"
  ...
  <body>
      ...
      <div class="container">
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            <div
              class="hero-content wow fadeInUp mx-auto max-w-[800px] text-center"
              data-wow-delay=".2s"
            >
              <h1
                class="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]"
              >
              Accelerate your development process with predefined REACT & Tailwind CSS UI components.  
              </h1>
              <p
                class="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]"
              >
              Welcome to the REACT components website. Explore our collection of predefined components and accelerate your development process.
              </p>
              <ul
    ...
    >
      ...
      <span class="block w-full max-w-[88px]">
        <img
          src="./assets/images/brands/easyui.svg"
          alt="tailgrids"
          class="dark:hidden"
        />
        <img
          src="./assets/images/brands/easyui-white.svg"
          alt="tailgrids"
          class="hidden dark:block"
        />
      </span>
